...
const EngineeringPartner = () => {
  useEffect(() => {
    setPageSeo({
      title: 'AUM AI — Healthcare Software Engineering & Product Development Partner',
      description: 'AUM AI is an AI-accelerated healthcare software engineering partner. We build production-grade platforms — FHIR & HL7 integrations, clinical NLP, quality measures, risk adjustment, and custom EHR — for the US healthcare industry.',
      canonical: 'https://aumai.co.in/engineering-partner',
...
export default EngineeringPartner;
