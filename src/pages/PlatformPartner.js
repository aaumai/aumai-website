...
const PlatformPartner = () => {
  ...
  return (
    <div className="aumy-page rev-page">
      ...
      {/* Compact trust strip — clinics will ask if it's compliant; answer it up front */}
      <section className="trust-strip">
        <div className="container">
          <div className="trust-strip-inner">
            <span className="trust-strip-label">Built on healthcare-grade infrastructure</span>
            <div className="trust-strip-badges">
              {['Patient Data Isolation', 'End-to-End Encryption', 'ABDM & FHIR R4 Ready', 'DPDP Act 2023 Aligned'].map((b, i) => (
            ...
            <span className="trust-strip-note">
              Full compliance details at <Link to="/compliance">aumai.co.in/compliance</Link>
            </span>
          </div>
        </div>
      </section>
